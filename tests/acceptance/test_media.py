...
pytestmark = pytest.mark.skipif(
    not hasattr(message_logic, "REASONING_MARKER"),
    reason=(
        "acceptance suite is master-scoped (REASONING_MARKER not on multitenant); "
        "multitenant has different message_logic API"
    ),
)
