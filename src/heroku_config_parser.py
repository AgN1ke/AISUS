...
class ConfigReader:
    def __init__(self):
        ...
        self.welcome_message = format_env_prompt(
            os.getenv("SYSTEM_MESSAGES_WELCOME_MESSAGE")
        )
        self.voice_message_affix = format_env_prompt(
            os.getenv("SYSTEM_MESSAGES_VOICE_MESSAGE_AFFIX")
        )
        self.image_message_affix = format_env_prompt(
            os.getenv("SYSTEM_MESSAGES_IMAGE_MESSAGE_AFFIX"),
            LEGACY_DEFAULT_IMAGE_MESSAGE_AFFIX,
        )
        self.image_caption_affix = format_env_prompt(
            os.getenv("SYSTEM_MESSAGES_IMAGE_CAPTION_AFFIX"),
            LEGACY_DEFAULT_IMAGE_CAPTION_AFFIX,
        )
        self.image_sence_affix = format_env_prompt(
            os.getenv("SYSTEM_MESSAGES_IMAGE_SENCE_AFFIX"),
            LEGACY_DEFAULT_IMAGE_SCENE_AFFIX,
        )
        self.password = format_env_prompt(os.getenv("PASSWORD"))
