...
class ConfigReader:
    def __init__(self) -> None:
        ...
        self.check_config_prompt: str = _format_message(
            os.getenv(
                "SYSTEM_MESSAGES_CHECK_CONFIG",
                "Будь ласка, перевірте налаштування конфігурації чату.",
            )
        )
    ...
    def get_system_messages(self) -> Dict[str, str]:
        return {
            ...
            "check_config_prompt": self.check_config_prompt,
        }
